...
from student_management_app.models import CustomUser, Staffs, Departments, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult
